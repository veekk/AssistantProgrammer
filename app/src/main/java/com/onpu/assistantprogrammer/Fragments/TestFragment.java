...
public class TestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        items.add(new Item(3, "Я не знаю, выберите за меня", new int[]{}));
        ...
        items.add(new Item(7, "Начните со Scratch, затем...", new int[]{}));
        ...
        items.add(new Item(12, "Простым способом", new int[]{}));
        items.add(new Item(13, "Лучшим способом", new int[]{}));
        items.add(new Item(14, "Трудненьким способом", new int[]{16}));
        items.add(new Item(15, "Очень сложный путь (но потом будет легче)", new int[]{}));
        items.add(new Item(16, "Какая коробка передач?", new int[]{17, 18}));
        items.add(new Item(17, "Автомат", new int[]{}));
        items.add(new Item(18, "Ручная", new int[]{}));
        ...
        items.add(new Item(24, "Lego", new int[]{}));
        items.add(new Item(25, "Пластилин", new int[]{}));
        items.add(new Item(26, "Старенький, но любимый мишка", new int[]{}));
        items.add(new Item(27, "Хотите попробовать что-то новое, но не очень трудоёмкое?", new int[]{21, 22, 28}));
        items.add(new Item(28, "Да", new int[]{}));
        ...
        items.add(new Item(33, "Какая платформа/сфера?", new int[]{34, 35, 36, 42, 49, 50}));
        items.add(new Item(34, "3D/игры", new int[]{}));
        ...
        items.add(new Item(38, "iOS", new int[]{}));
        items.add(new Item(39, "Android", new int[]{}));
        items.add(new Item(40, "Фронтенд (веб-интерфейс)", new int[]{}));
        ...
        items.add(new Item(46, "Люблю его :)", new int[]{}));
        items.add(new Item(47, "Неплохо :|", new int[]{}));
        items.add(new Item(48, "Фууууу :(", new int[]{}));
        items.add(new Item(49, "Я просто хочу $$$", new int[]{}));
